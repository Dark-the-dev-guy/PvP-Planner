// events/handlers/statusHandlers/tentativeHandler.js
 ...
 */
async function handleTentative(interaction, session, userId, username) {
  try {
    ...
    if (existingGamer) {
      if (existingGamer.status === "tentative") {
        ...
        existingGamer.status = "tentative";
        ...
        await session.save();
        logStatusUpdate(userId, session.sessionId, 'tentative', {
        ...
        if (hasNeededInfo) {
          ...
          await interaction.editReply({
            content: `✅ You're marked as tentative with your ${charType} character. Select your role:`,
...
module.exports = handleTentative;